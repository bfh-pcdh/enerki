...
export const QUIZ: QuizCard[]  = [
    ...
    {
        id: '4',
        question: 'Um wie viel Grad hat sich die durchschnittliche Erdtemperatur seit der vorindustriellen Zeit erhöht?',
        prompts: [
    ...
    {
        id: '5',
        question: 'Was ist laut der WHO die grösste Gesundheitsbedrohung für die Menschheit im 21. Jahrhundert?',
        prompts: [
    ...
    {
        id: '6',
        question: 'Welche Transportmittel sollen laut WHO in Städten priorisiert werden?',
        prompts: [
